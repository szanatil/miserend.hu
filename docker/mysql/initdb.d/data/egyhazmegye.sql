...
(2,'Eger',2,'i','','','i',5635586),
(3,'Esztergom-Budapest',3,'i','esztergom','','i',5635587),
(4,'Győr',4,'i','','','n',5635589),
(6,'Kalocsa-Kecskemét',6,'i','','','i',5635590),
(7,'Kaposvár',7,'i','','','i',12535238),
(8,'Pécs',10,'i','','','i',5638351),
(9,'Szeged-Csanád',11,'i','','','i',5635591),
(10,'Székesfehérvár',12,'i','','','i',5635765),
(11,'Szombathely',13,'i','','','n',5665523),
(12,'Vác',14,'i','','','i',5635592),
(13,'Veszprém',15,'i','','','i',13004858),
(15,'Pannonhalmi Területi Apátság',9,'i','','','i',13005188),
(16,'Tábori Püspökség',16,'i','','','i',NULL),
(17,'Miskolci egyházmegye (gk)',8,'i','','','i',14735845),
(18,'Hajdúdorogi metropólia (gk)',5,'i','','','i',14735896),
(19,'Munkácsi em. (Kárpátalja)',17,'i','','','i',NULL),
(20,'Gyulafehérvári főem. (Erdély)',18,'i','','','i',NULL),
(21,'Szatmári em. (Erdély)',20,'i','','','i',NULL),
(22,'Nagyváradi egyházmegye (Erdély)',19,'i','','','i',NULL),
...
(27,'Rozsnyói em. (Felvidék)',28,'i','','','i',NULL),
